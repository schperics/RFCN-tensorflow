...
class RunManager():
    ...
    def modRun(self, counter, feed_dict=None, options=None, run_metadata=None):
        ...
        return self.runAndMerge(feed_dict, options=options if options is not None else self.options,
                                run_metadata=run_metadata if run_metadata is not None else self.run_metadata)
